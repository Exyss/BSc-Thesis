...
Through this representation, each refutation produces a directed acyclic graph (DAG), also known as dag-like refutation. When each clause appears only once in a refutation, we say that it is a \textit{tree-like} refutation due to how the underlying graph becomes a tree.
