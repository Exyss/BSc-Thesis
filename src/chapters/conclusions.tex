...
\begin{figure}[H]
    ...
    \begin{tikzpicture}[->,>=stealth,shorten >=1pt,auto,node distance=1.3cm, thick,main node/.style={scale=0.9,circle,draw,font=\sffamily\normalsize}]
        ...
        \node[rectangle, draw, rounded corners, minimum width=15mm, minimum height=6mm]  (1) []{\textsf{FNP}$^{dt}$};
 ...
 (4) edge[dashed, near end, color=blue] node[yshift=7.5, xshift=-30]{\Cref{pls_dt_not_inside_fp_pdt}}(12) 
 (11) edge[color=blue] node{\Cref{fp_pdt_not_inside_fp_dt}}(12) 
 (12) edge[color=blue, bend right, swap] node{\Cref{final_inclusion}}(5) 
